...
a = Analysis(
    ...
    hiddenimports=[
        ...
        "image_dedup.engine.video",
        "image_dedup.engine.semantic",
        "image_dedup.gui",
        ...
        "image_dedup.gui.comparison_widget",
        "image_dedup.gui.tray",
        "image_dedup.gui.theme",
        "image_dedup.report",
        "image_dedup.report.html_report",
        "image_dedup.report.excel_report",
        "image_dedup.report.pdf_report",
        "PIL",
        "PIL.Image",
        "PIL.ExifTags",
        "pillow_heif",
